                ...
                <Zoom>
                  ...
                  >
                    <div className="max-w-4xl items-start text-start">
                      ...
                      <div>
                        <Typography>{selectedProject.date}</Typography>
                      </div>
                      ...
                      <div className="">
                        <ul className="flex gap-2 mb-2">
                          {selectedProject.languages.map((element, index) => (
                            <li
                              key={index}
                              className="text-2xl p-2 rounded-md text-white"
                        ...
                        <div className="mt-4 flex gap-2">
                          <a
                            style={{
                              backgroundColor:
                                programmingLanguages_.github.color,
                            }}
                            className="text-white p-2 rounded-md items-center"
                            href={selectedProject.link}
                            target="_blank"
                          >
                            {programmingLanguages_.github.class} GitHub
