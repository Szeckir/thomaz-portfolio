...
export const projects = {
    project1: {
        ...
        date: "October 2024",
        bigDescription: "Fiz um projeto do zero para minha barbearia aqui dos Estados Unidos, o projeto está em inglês, pois atualmente está sendo utilizada pela barbearia.",
        languages: [
